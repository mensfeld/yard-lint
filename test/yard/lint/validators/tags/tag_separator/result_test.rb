...
describe "Yard::Lint::Validators::Tags::TagSeparator::Result" do
  attr_reader :config, :parsed_data, :result

  before do
    @config = Yard::Lint::Config.new
    @parsed_data = []
    @result = Yard::Lint::Validators::Tags::TagSeparator::Result.new(@parsed_data, @config)
  end
  ...
  it "class methods defines default severity as convention" do
    assert_equal("convention", Yard::Lint::Validators::Tags::TagSeparator::Result.default_severity)
  end

  it "class methods defines offense type as method" do
    assert_equal("method", Yard::Lint::Validators::Tags::TagSeparator::Result.offense_type)
  end

  it "class methods defines offense name as missingtagseparator" do
    assert_equal("MissingTagSeparator", Yard::Lint::Validators::Tags::TagSeparator::Result.offense_name)
  end
  ...
  it "build message generates human readable message" do
    ...
    r = Yard::Lint::Validators::Tags::TagSeparator::Result.new(parsed_data, config)
