...
class YardLintValidatorsWarningsInvalidTagFormatResultTest < Minitest::Test
  attr_reader :config, :parsed_data, :result

  def setup
    @config = Yard::Lint::Config.new
    @parsed_data = []
    @result = Yard::Lint::Validators::Warnings::InvalidTagFormat::Result.new(parsed_data, config)
  end
