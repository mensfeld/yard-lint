...
class YardLintValidatorsDocumentationUndocumentedMethodArgumentsParserTest < Minitest::Test
  attr_reader :parser

  def setup
    @parser = Yard::Lint::Validators::Documentation::UndocumentedMethodArguments::Parser.new
  end
