...
RSpec.describe Yard::Lint::Validators::Tags::ExampleStyle do
  describe 'module structure' do
    ...
    it 'has LinterDetector class' do
      expect(described_class.const_defined?(:LinterDetector)).to be true
    end

    it 'has RubocopRunner class' do
      expect(described_class.const_defined?(:RubocopRunner)).to be true
    end
  end
end
