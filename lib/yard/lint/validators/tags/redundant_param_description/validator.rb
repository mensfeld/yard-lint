      ...
      module Tags
        module RedundantParamDescription
          ...
          class Validator < Validators::Base
            ...
            def in_process_query(object, collector)
              ...
              object.docstring.tags.each do |tag|
                ...
                pattern_type = detect_pattern(
                  ...
                  articles, generic_terms, connectors, patterns
                )
            ...
            def detect_pattern(param_name, description, type_name, word_count, articles, generic_terms, connectors, patterns)
              ...
              # ArticleParamPhrase pattern: "The action being performed", "the value to format"
              if patterns['ArticleParamPhrase'] && word_count >= 3 && desc_parts.length >= 3 &&
                 ...
                 (desc_parts.length == 3 || desc_parts.length == 4)
