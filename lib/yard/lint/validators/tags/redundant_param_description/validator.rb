      ...
      module Tags
        module RedundantParamDescription
          ...
          class Validator < Validators::Base
            ...
            def config_articles
              config.validator_config('Tags/RedundantParamDescription', 'Articles') || Config.defaults['Articles']
            end

            # @return [Array<String>] configured generic terms to check
            def config_generic_terms
              config.validator_config('Tags/RedundantParamDescription', 'GenericTerms') || Config.defaults['GenericTerms']
            end
            ...
            def config_checked_tags
              config.validator_config('Tags/RedundantParamDescription', 'CheckedTags') || Config.defaults['CheckedTags']
            end

            # @return [Hash] enabled pattern detection flags
            def config_enabled_patterns
              config.validator_config('Tags/RedundantParamDescription', 'EnabledPatterns') || Config.defaults['EnabledPatterns']
            end
          end
        end
      end
